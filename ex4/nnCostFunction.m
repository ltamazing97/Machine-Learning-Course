...
%
regularized1 = lambda * Theta1 / m;  %25*401
regularized2 = lambda * Theta2 / m; %10*26

regularized1(:,1) = zeros(size(regularized1,1),1);
regularized2(:,1) = zeros(size(regularized2,1),1);
